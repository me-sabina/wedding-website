...
<body>
     ...
     if ($_SERVER['REQUEST_METHOD']=="POST"){
      ...
      elseif(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        vendor_type,vendor_name,user_Message) VALUES
         ('$fname','$lname','$email','$phone','$date','Makeup&Boutique','$svendor','$message')";
  ...
  <form action="" method="post">
   ...
   <div id="phone">
    ...
    <div id="vendate">
      <div id="vendor">
    <label for="mvendor">Choose your vendor:</label><br>
    <select  name="mvendor">
      <option value="CELAVON BEAUTY SALON">CELAVON BEAUTY SALON</option>
      <option value="ELEGANT GLOW MAKEUP STUDIO">ELEGANT GLOW MAKEUP STUDIO</option>
      <option value="GLAMOUR MAKEUP STUDIO">GLAMOUR MAKEUP STUDIO</option>
      <option value="LUMI SALON">LUMI SALON</option>
      <option value="BELLATERA PARLOUR">BELLATERA PARLOUR</option>
    </select><br>
    </div>
    <div id="date">
