...
<body>
     ...
     if ($_SERVER['REQUEST_METHOD']=="POST"){
      ...
      elseif(!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        vendor_type,vendor_name,user_Message) VALUES
         ('$fname','$lname','$email','$phone','$date','Cake Decor','$svendor','$message')";
  ...
  <form action="" method="post">
   ...
   <div id="phone">
    ...
    <div id="vendate">
      <div id="vendor">
    <label for="cvendor">Choose your vendor:</label><br>
    <select  name="cvendor">
      <option value="VEINAA BAKERY HOUSE">VEINAA BAKERY HOUSE</option>
      <option value="HERMAN HELMOTZS BAKERY">HERMAN HELMOTZS BAKERY</option>
      <option value="MILAS EUROPEAN BAKERY">MILAS EUROPEAN BAKERY</option>
      <option value="HONEY BUTTER BAKERY">HONEY BUTTER BAKERY</option>
      <option value="WEDDING CAKES BY SOWNA">WEDDING CAKES BY SOWNA</option>
    </select><br>
    </div>
    <div id="date">
