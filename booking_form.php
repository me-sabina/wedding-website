...
<body>
  ...
  <form action="" method="post">
   ...
   <div id="phone">
    ...
    <div id="vendate">
      <div id="vendor">
    <label for="vendor">Choose your vendor:</label><br>
    <select  name="vendor">
      <option value="JS PHOTOGRAPHY">JS PHOTOGRAPHY</option>
      <option value="THE DREAMS PRODUCTION">THE DREAMS PRODUCTION</option>
      <option value="CU-ZAN CREATION">CU-ZAN CREATION</option>
      <option value="URBAN PHOTOGRAPHY">URBAN PHOTOGRAPHY</option>
      <option value="BLOOM DIGITAL STUDIO">BLOOM DIGITAL STUDIO</option>
    </select><br>
    </div>
    <div id="date">
